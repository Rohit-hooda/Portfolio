...
function About() {
    return (
        <div name="about"
             className='display-flex flex-col justify-center items-center w-full h-screen bg-gradient-to-b from-gray-800 to-black w-max-content mx-auto my-auto h-max-content text-white'>
            ...
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
                ...
                <div>
                    <p className='text-xl mt-20'>
                        Passionate about Software development and currently a graduate student at
                        Northeastern University.
                        After the completion of my Bachelor from GTU Gujarat,
                        India worked for TechNeos Solutions,Ahmedabad, India for 6 months as a
                        Software Developer Intern.
                        I have a track record of developing code and digital solutions using
                        cutting-edge technologies for startups.
                        Other than that was also responsible for support where it needed to resolve
